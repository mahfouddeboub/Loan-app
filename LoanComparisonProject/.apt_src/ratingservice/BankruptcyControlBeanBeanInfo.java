...
public class BankruptcyControlBeanBeanInfo
extends org.apache.beehive.controls.system.jdbc.JdbcControlBeanBeanInfo
{
    ...
    */
    public BankruptcyControlBeanBeanInfo()
    {
        super(ratingservice.BankruptcyControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected BankruptcyControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(ratingservice.BankruptcyControlBean.class);
        bd.setName( "BankruptcyControlBean" );
        bd.setDisplayName( "BankruptcyControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for findApplicant(ni)
        //
        __bc_paramNames = _methodParamMap.get(_findApplicantMethod);
        ...
        md = new MethodDescriptor(_findApplicantMethod, __bc_paramDescriptors);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , ratingservice.BankruptcyControlBean.class, "getControlImplementation", "setControlImplementation");
