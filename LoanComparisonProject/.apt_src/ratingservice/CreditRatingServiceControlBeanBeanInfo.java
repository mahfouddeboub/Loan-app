...
public class CreditRatingServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public CreditRatingServiceControlBeanBeanInfo()
    {
        super(ratingservice.CreditRatingServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected CreditRatingServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(ratingservice.CreditRatingServiceControlBean.class);
        bd.setName( "CreditRatingServiceControlBean" );
        bd.setDisplayName( "CreditRatingServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for creditResult(emp_arg, salary_arg, ni_arg)
        //
        __bc_paramNames = _methodParamMap.get(_creditResultMethod);
        ...
        md = new MethodDescriptor(_creditResultMethod, __bc_paramDescriptors);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , ratingservice.CreditRatingServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = ratingservice.CreditRatingServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            ratingservice.CreditRatingServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            ratingservice.CreditRatingServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            ratingservice.CreditRatingServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
