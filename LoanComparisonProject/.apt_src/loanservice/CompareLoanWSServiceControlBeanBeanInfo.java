...
public class CompareLoanWSServiceControlBeanBeanInfo
extends com.bea.control.ServiceControlBeanBeanInfo
{
    ...
    */
    public CompareLoanWSServiceControlBeanBeanInfo()
    {
        super(loanservice.CompareLoanWSServiceControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected CompareLoanWSServiceControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(loanservice.CompareLoanWSServiceControlBean.class);
        bd.setName( "CompareLoanWSServiceControlBean" );
        bd.setDisplayName( "CompareLoanWSServiceControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for checkCreditRating(emp_arg, salary_arg, ni_arg)
        //
        __bc_paramNames = _methodParamMap.get(_checkCreditRatingMethod);
        ...
        md = new MethodDescriptor(_checkCreditRatingMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
        
        //
        // Declare MethodDescriptor for requestLoan(minLoan_arg, period_arg)
        //
        __bc_paramNames = _methodParamMap.get(_requestLoanMethod);
        __bc_paramDescriptors = new ParameterDescriptor[__bc_paramNames.length];
        for (int j = 0; j < __bc_paramNames.length; j++)
        {
            __bc_paramDescriptors[j] = new ParameterDescriptor();
        ...
        md = new MethodDescriptor(_requestLoanMethod, __bc_paramDescriptors);
        methodDescriptors[index++] = md;
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , loanservice.CompareLoanWSServiceControlBean.class, "getControlImplementation", "setControlImplementation");
    ...
    protected void initCallbackEvents(MethodDescriptor [] eventDescriptors, int index)
    {
        ...
        //
        initCallbackEvents(eventDescriptors, index);
    }
    ...
    throws java.beans.IntrospectionException
    {
        ...
        __bc_eventIntf = loanservice.CompareLoanWSServiceControl.Callback.class;
        ...
        {
            __bc_addListener =
            loanservice.CompareLoanWSServiceControlBean.class.getDeclaredMethod("addCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_removeListener =
            loanservice.CompareLoanWSServiceControlBean.class.getDeclaredMethod("removeCallbackListener",
            new Class [] { __bc_eventIntf });
            __bc_getListeners =
            loanservice.CompareLoanWSServiceControlBean.class.getDeclaredMethod("getCallbackListeners",
            new Class [] {});
        }
        catch (NoSuchMethodException __bc_nsme)
        {
    ...
    {
        EventSetDescriptor [] __bc_eventSetDescriptors = new EventSetDescriptor[2];
        try
        {
