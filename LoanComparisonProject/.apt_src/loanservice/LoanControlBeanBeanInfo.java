...
public class LoanControlBeanBeanInfo
extends org.apache.beehive.controls.system.jdbc.JdbcControlBeanBeanInfo
{
    ...
    */
    public LoanControlBeanBeanInfo()
    {
        super(loanservice.LoanControlBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected LoanControlBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(loanservice.LoanControlBean.class);
        bd.setName( "LoanControlBean" );
        bd.setDisplayName( "LoanControlBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for findLoan(minLoan, period)
        //
        __bc_paramNames = _methodParamMap.get(_findLoanMethod);
        ...
        md = new MethodDescriptor(_findLoanMethod, __bc_paramDescriptors);
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , loanservice.LoanControlBean.class, "getControlImplementation", "setControlImplementation");
