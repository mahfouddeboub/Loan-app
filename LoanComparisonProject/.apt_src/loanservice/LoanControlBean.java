...
public class LoanControlBean
extends org.apache.beehive.controls.system.jdbc.JdbcControlBean
implements loanservice.LoanControl
{
    static final Method _findLoanMethod;
    ...
    static
    {
        ...
        try
        {
            _findLoanMethod = loanservice.LoanControl.class.getMethod("findLoan", new Class [] {int.class, int.class});
            _methodParamMap.put(_findLoanMethod, new String [] { "minLoan", "period" });
        }
    ...
    */
    public LoanControlBean(ControlBeanContext context, String id, PropertyMap props)
    {
        this(context, id, props, loanservice.LoanControl.class);
    }
    ...
    */
    protected LoanControlBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
    ...
    */
    ...
    /**
    * Implements loanservice.LoanControl.findLoan
    */
    public  loanservice.Loan[] findLoan(int minLoan, int period) 
    {
        Object [] __bc_argArray = new Object[] { minLoan, period };
        ...
        try
        {
            preInvoke(_findLoanMethod, __bc_argArray);
            
            __bc_retval =
            (loanservice.Loan[])
            __bc_target.invoke(_findLoanMethod, __bc_argArray)
            ;
        }
        ...
        finally
        {
            ...
            postInvoke(_findLoanMethod, __bc_argArray, __bc_rv, __bc_thrown);
        }
        return __bc_retval;
    }
